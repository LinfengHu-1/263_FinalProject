...
svm_model <- svm(MICHD ~ .-CVDINFR4-CVDCRHD4, data = train, cost = 1, sigma = 0.1,kernel = "radial")
...
svm_linear <- train(MICHD ~ .-CVDINFR4-CVDCRHD4, data = train, method = "svmLinear", trControl = ctrl, tuneGrid = SVMlinearGrid, metric = "ROC")
